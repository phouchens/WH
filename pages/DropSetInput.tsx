...
import { DropSetForm } from '../Components/DropSetForm'

export default class DropSetInput extends React.Component {
  state = {
    isLbs: true,
    amount: ''
  }
  ...
  render() {
    ...
    return (
      <View style={styles.masterContainer}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Please Enter Weight to Determine Drop"
          mode="outlined"
        ...
        />
        {amount ? <Header /> : null}
        <View>{amount ? <DropSetForm amount={amount} /> : null}</View>
      </View>
    )
  }
}
